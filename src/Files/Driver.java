...
Connection con;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Driver Record"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if (txtname.getText().equals("") && txtid.getText().equals("")) {
            ...
            String query = "INSERT INTO `driver`(`Name`, `Id`, `status`) VALUES(?,?,?)";
            try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       String search = JOptionPane.showInputDialog("Enter the Driver's ID Number");
        String query = "SELECT * FROM `driver` WHERE `Id` LIKE '" + search + "'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String query = "UPDATE `driver` SET `Name` = '" + txtname.getText()
                + "' WHERE `driver`.`Id` = '" + txtid.getText() + "'";
        try {
            ps = con.prepareStatement(query);
            ps.executeUpdate();
            clear();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       String delete = JOptionPane.showInputDialog(null, "Enter Driver IDNO.");

        try {
            ps = con.prepareStatement("DELETE FROM `driver` WHERE `driver`.`Id` = '" + delete + "'");
            ps.executeUpdate();
